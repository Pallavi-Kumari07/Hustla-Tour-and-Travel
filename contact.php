...
<body>
    ...
    <br>
    <br>
    <h2 style='background-color: rgba(182, 176, 176, 0.1);'>CONTACT US</h2>
    <section>
        <div class="box">
            <p class="para">@HustlaOfficial</p>
            <p class="para">@Hustla_OnFacebook</p>
            <p class="para">@Visit_LinkedIn</p>
        </div>
    </section>
    <nav class="line"></nav>
    <div class="footer">
